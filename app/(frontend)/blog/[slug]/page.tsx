  ...
  return (
    <article>
      <header className="mb-8">
        <Link href="/blog" className="text-sm text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 mb-4 inline-block">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            {tags?.map((tag) => (
              <Link
                ...
                className="text-xs px-2 py-1 border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 rounded hover:bg-zinc-50 dark:hover:bg-zinc-800"
              >
                #{tag.name}
              </Link>
            ))}
